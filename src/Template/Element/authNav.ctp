<ul class="nav navbar-nav pull-right">
    ...
    <li class="<?= (isset($activeItem) && $activeItem ==='connexions' ? 'active' : '') ?>"><?= $this->Html->link('Ajout de connexions','/connections/index') ?></li>
    <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown"><?= $authUserName ?><b class="caret"></b></a>
        <ul class="dropdown-menu">
            <li><?= $this->Html->link('Mes connexions','/connections/view') ?></li>
